...
$.extend($.validator, {
	...
	messages: {
		...
		number: "Por favor entre com um número válida.",
		digits: "Por favor entre somente com digitos.",
		creditcard: "Por favor entre com um cartão de crédito válido.",
		equalTo: "Por favor entre com o mesmo valor novamente.",
		accept: "Por favor entre com uma extensão válida.",
		maxlength: $.validator.format("Por favor entre com não mais que {0} caracteres."),
